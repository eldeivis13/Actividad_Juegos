...
public class Prueba4 extends JFrame {
	...
	public Prueba4() {
		...
		lblNewLabel_3.setBounds(668, 349, 16, 32);
		contentPane.add(lblNewLabel_3);
		
		JLabel lblNewLabel = new JLabel(".");
		lblNewLabel.setFont(new Font("Tahoma", Font.PLAIN, 40));
		lblNewLabel.setBounds(124, 341, 26, 45);
		...
		BotonPuerta_1.setBounds(26, 535, 124, 45);
		...
		BotonPuerta_2.setBounds(204, 535, 124, 45);
		...
		BotonPuerta_3.setBounds(402, 535, 124, 45);
		...
		BotonPuerta_4.setBounds(579, 535, 118, 45);
